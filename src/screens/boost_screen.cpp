...
void BoostScreen::create(lv_obj_t* parent) {
    ...
    map_.create(root_, 0, 0, kCol * 2, kRow, "MAP / BOOST TGT", "kPa", &lv_font_montserrat_28);
    ...
    tableSet_.create(root_, kCol * 2, 0, kCol, kRow, "BOOST SET", "", &lv_font_montserrat_28);

    duty_.create(root_, 0, kRow, kCol, kRow, "BOOST DC", "%", &lv_font_montserrat_28);
    pidCorrection_.create(root_, kCol, kRow, kCol, kRow, "BOOST PID", "%", &lv_font_montserrat_28);
    errorCorrection_.create(root_, kCol * 2, kRow, kCol, kRow, "ERR COR", "%", &lv_font_montserrat_28);

    rpm_.create(root_, 0, kRow * 2, kCol, kRow, "RPM", "rpm", &lv_font_montserrat_28);
    tps_.create(root_, kCol, kRow * 2, kCol, kRow, "TPS", "%", &lv_font_montserrat_28);
    afr_.create(root_, kCol * 2, kRow * 2, kCol, kRow, "AFR", "", &lv_font_montserrat_28);
}
